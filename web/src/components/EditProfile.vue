...
const { modal, isOpenLogin, isOpenRegisterGym, isOpenSignUp, isOpenEditProfile, firstName, lastName, email, password, conPassword, message } = storeToRefs(home);
