        ...
        <div
            ...
            <div class="flex justify-between">
                <div>
                    ...
                    <input v-model="search" type="text" name="" id="" class="bg-transparent p-2 outline-none" placeholder="Search Gyms" />
                </div>
                <span>
                    <span></span>
            ...
            <div class="overflow-auto rounded-lg shadow hidden md:block">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="" v-for="i in allItems" :key="i.id">
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap uppercase" >{{ i.UserRole.roleName }}</td>
                            <!-- <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                <span
